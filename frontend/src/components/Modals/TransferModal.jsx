...
const TransferModal = ({ isOpen, onClose }) => {
    ...
    const handleTransfer = async (e) => {
        ...
        if (transferAmt < 10) return setError("Minimum transfer amount is $10.");
        if (transferAmt > displayBalance) return setError("Insufficient balance in Main Wallet!");
                    ...
                    <div className="p-6 overflow-y-auto custom-scroll space-y-6">
                        ...
                        <form onSubmit={handleTransfer} className="space-y-5">
                            ...
                            <div className="bg-gray-50/50 p-4 rounded-3xl border border-gray-100">
                                <label className="block text-[10px] font-black text-gray-500 mb-2 uppercase tracking-widest ml-1">Transfer To (Downline ID Only)</label>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-[10px] font-black text-gray-500 mb-1.5 uppercase tracking-widest ml-1">Transfer Amount (Min $10)</label>
                                    <div className="relative">
                            ...
                            <div className="sticky bottom-0 pt-2 bg-white pb-2">
                                <button 
                                    type="submit" 
                                    disabled={loading || isSearching || !receiverName || Number(amount) < 10} 
